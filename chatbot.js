...
const translations = {
    ...
    'project-1-description-pt-br': '<br><p>Eu desenvolvi código em C apresenta a implementação de um jogo de cartas estratégico e tático, onde dois jogadores se enfrentam em uma série de rodadas. Cada jogador recebe uma mão de cartas de um baralho que inclui cartas de diferentes cores e valores. O <strong>objetivo</strong> é vencer as rodadas acumulando pontos, que são determinados pelo resultado de combates entre as cartas jogadas pelos jogadores.</p><br><p>Este projeto foi um trabalho de Lógica e algoritimo da minha graduação em Sistemmas da Informmação na Universidade Federal de Santa Maria em 2023.</p></br>',
    'project-1-description-en': '<br><p>I developed code in C that implements a strategic and tactical card game, where two players face each other in a series of rounds. Each player receives a hand of cards from a deck that includes cards of different colors and values. The <strong>goal</strong> is to win the rounds by accumulating points, which are determined by the result of battles between the cards played by the players.</p><br><p> This project was a Logic and algorithm work of my graduation in Information Systems at the Federal University of Santa Maria in 2023. Technologies used: C.</p><br>',
